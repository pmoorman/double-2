...
logo: "./logo.png"
weight: 5 # The lower the number, the higher the priority
...
# seo
seo_title: Scaling TikTok for Business | Growth Marketing Case Study
seo_description: Something wasn't adding up. Based on TikTok's unreal success, businesses should have been flooding in to partner up as advertisers...
seo_keywords: Scaling TikTok for Business, Growth Marketing Case Study
...
grid_item:
  ...
  size: "square"
  weight: 1000
  homepageweight: 100 # The lower the number, the higher the priority
  homepageimage: ./tiktok-carousel.jpg
  tags:
    - Infrastructure
    - Performance
    - B2B
